	...
	def train(epoch: int):
		...
		for iteration, batch in enumerate(training_data_loader, 1):
			...
			training_status.code(
				"===> Epoch[{}/{}]({}/{}): Loss: {:.4f}".format(epoch, training_opt.nEpochs, iteration, len(training_data_loader), loss.item()))

		training_status.code(
			"===> Epoch {} Complete: Avg. Loss: {:.4f}".format(epoch, epoch_loss / len(training_data_loader)))
