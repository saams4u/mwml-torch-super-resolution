# train_srresnet.py - initialize and train a SRResNet model.
...
n_channels = 64  # number of channels in-between, i.e. the input and output channels 
...
def train(train_loader, model, criterion, optimizer, epoch):
	model.train()  # training model enables batch normalization
