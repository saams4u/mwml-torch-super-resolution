# train_srgan.py - initialize and train a SRGAN model.
...
beta = 1e-3  # the coefficient to weigh the adversarial loss in the perpectual loss
...
def train(train_loader, generator, discriminator, truncated_vgg19, content_loss_criterion, adversarial_loss_criterion,
	...
	losses_c = AverageMeter()  # content_loss
